...
public final class Prompts {
    ...
    public static final String INTENT_INSTRUCTIONS = """
            ...
            - Threshold language such as threshold, band range, low medium high critical range, or score range must add SHOW_MODEL_SCORE_THRESHOLDS if that intent exists in the allowed list; otherwise add SHOW_RISK_BAND.
